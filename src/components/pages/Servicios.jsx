...
import './pages.css';// Asegúrate de crear y aplicar este archivo CSS
  ...
  return (
    ...
    <div className="servicios">
      ...
      <section className="ubicacion">
        ...
        <p>Estamos ubicados en Avd. Blas Infante, 8 (El Recinto).<br/>¡Ven a disfrutar de nuestra deliciosa comida en un ambiente acogedor!</p>
        <iframe 
          title="Mapa"
